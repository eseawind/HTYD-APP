...
public class CzpBottomMenuAdapter extends BaseAdapter {

	private Context context;
	private String[] menuName;
	private BottomMenuClickListener mListener;

	public interface BottomMenuClickListener {
		public void onBottomMenuClickListener(int position);
	}

	public CzpBottomMenuAdapter(Context context, String[] menuName) {
		super();
		this.context = context;
		this.menuName = menuName;
		mListener = (BottomMenuClickListener) context;
	}
	...
	private OnClickListener menuItemClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			mListener.onBottomMenuClickListener(position);
		}
	};
}
